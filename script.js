            ...
            for (let i = 0; i < nombres.length; i++) {
                for (let j = i + 1; j < nombres.length; j++) {
                    ...
                    const aspectos = [
                        ...
                        { tipo: 'sextil', angulo: 60, strokeWidth: 2.25, dasharray: '5,5', opacity: 0.5 },
                        { tipo: 'cuadratura', angulo: 90, strokeWidth: 2.25, dasharray: null, opacity: 0.5 },
                        { tipo: 'trígono', angulo: 120, strokeWidth: 2.25, dasharray: '5,10', opacity: 0.5 },
